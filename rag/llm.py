...
def get_llm():
    ...
    model_name = getattr(settings, "RAG_LLM_MODEL", "Qwen/Qwen2-0.5B-Instruct")
...
def generate_answer(question, context):
    ...
    answer = tokenizer.decode(generated_ids, skip_special_tokens=True, clean_up_tokenization_spaces=True)
